...
class Agent:
    ...
    def _model(self):
        """Creates the model
        """
        model = tf.keras.models.Sequential([tf.keras.layers.Input(shape=self.state_size),
    ...
    def save(self, episode):
        self.model.save("src/models/{}_{}".format(self.model_name, episode))

    def load(self):
        return load_model("src/models/" + self.model_name, custom_objects=self.custom_objects)
